...
import { requestDeletedTopics } from "../../../action/topics";

function DeleteTopics({ open, close, id, title }) {
  ...
  function closeModal() {
    close((prev) => ({ ...prev, show: false }));
  }

  function handleDeleted() {
    requestDeletedTopics(setTopicsDeleted, id);
  }
